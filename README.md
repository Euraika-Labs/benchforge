...
| Compare a local server to a cloud model | Let the Dashboard route ready setup, then use **Launch comparison** in Run Builder or the primary Dashboard comparison button |
