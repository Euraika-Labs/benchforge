...
3. On the Dashboard, click **Run model comparison** to validate both sides and queue the capped default pack, or use the Run Builder/Targets local-cloud shortcuts for more control. Shortcuts prefer cloud targets with input/output pricing so capped runs can estimate spend.
